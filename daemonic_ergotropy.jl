...
# === DAEMONIC ERGOTROPY (AND CAPACITY) AND RESPECTIVE MOMENTS COMPUTATION ====
...
#   6. Central moments reconstruction
...
println("Daemonic ergotropy (and respective moments) computation (", unravelling, ", initial ", instate, " state, α/κ = ", α_val, ", η = ", η_val, ", ", NUMBER_OF_TIMEINTERVALS, " time intervals and ", NUMBER_OF_TRAJECTORIES, " number of trajectories)...")
